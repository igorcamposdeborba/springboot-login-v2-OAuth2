...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.POST, EVENT_GET).hasAnyRole("CLIENT") // liberar só o método POST para quem possui esta role
			.antMatchers(PUBLIC_RESOURCES).hasAnyRole("ADMIN") // liberar tudo para quem possui essa role
